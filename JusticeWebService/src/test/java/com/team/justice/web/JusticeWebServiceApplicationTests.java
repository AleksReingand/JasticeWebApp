...
public class JusticeWebServiceApplicationTests {
	...
	public void createData() {
		...
		ClubDto clubDto = new ClubDto(new ClubIdDto("Israel", "Israel"), addressDto, Collections.emptyList(),
		...
		AthleteDto athleteDto = new AthleteDto("Ivan", "000000", "Ivan", "Ivanov", "12-12-2012", null, null,
				StatusGender.MALE, 54.3, StatusAthlete.ACTIVE, "12345", "Israel", "TelAviv");
	}
